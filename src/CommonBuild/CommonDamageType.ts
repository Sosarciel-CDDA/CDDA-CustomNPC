...
function Electrify(dm:CDataManager){
    ...
    const onDmgEoc:Eoc={
        ...
        eoc_type:"ACTIVATION",
        id:CMDef.genEOCID(`${did}_OnDamage`),
        effect:[
            //regenDmg,
...
function Discharge(dm:CDataManager){
    ...
    const tspell:Spell={
        type:"SPELL",
        id:CMDef.genSpellID(`${did}_Trigger`),
        name:"放电感电触发伤害",
...
function Knockback(dm:CDataManager){
    ...
    const tspell_subdamage:Spell={
        type:"SPELL",
        id:CMDef.genSpellID(`${did}_Subdamage`),
        name:"击退触发子伤害",
        description:"击退触发子伤害",
        effect:"attack",
        damage_type:"bash",
    ...
    const tspell_subknockback:Spell={
        type:"SPELL",
        id:CMDef.genSpellID(`${did}_Subknockback`),
        name:"击退触发子击退",
        description:"击退触发子击退",
        effect:"area_push",
        min_aoe:2,
    ...
    const onDmgEoc:Eoc={
        ...
        effect:[
            ...
            {run_eoc_until:{
                id:CMDef.genEOCID(`${did}_OnDamage_each`),
                eoc_type:"ACTIVATION",
                effect:[
