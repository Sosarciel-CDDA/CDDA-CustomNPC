...
import { CCommonEventType, CGlobalEventType } from "CnpcEvent";
 ...
 * @param cooldown 触发间隔
 */
export function genTriggerEffect(dm:DataManager,effect:Effect,hook:CGlobalEventType,mode:"/2"|"-1"|"none",
