...
/**手持触发 */
function genWieldTrigger(dm:DataManager,flagId:FlagID,hook:CnpcEventType,effects:EocEffect[],condition?:BoolObj){
...
export async function enchTest(dm:DataManager,enchSets:EnchSet[]){
    ...
    out.push(genActEoc(NONEEocId,[],undefined,true));
            ...
            effect_on_conditions:[{
                ...
                effect:[{
                    ...
                    then:[{
                        ...
                        title:"选择需要调试的物品",
                        true_eocs:{
                            id:"EnchTestTool_SelectItem" as EocID,
                            eoc_type:"ACTIVATION",
                            effect:[{
