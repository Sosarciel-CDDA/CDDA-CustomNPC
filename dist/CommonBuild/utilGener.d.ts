 ...
 * @param cooldown 触发间隔
 */
export declare function genTriggerEffect(dm: DataManager, effect: Effect, hook: GlobalEventType, eocEffects: EocEffect[], duration: Time, condition?: BoolObj, cooldown?: Time): Eoc;
/**创建添加效果的Eoc
