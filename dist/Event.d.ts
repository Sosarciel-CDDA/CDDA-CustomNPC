 ...
 * u为角色 n不存在
 */
export declare const CommonEventTypeList: readonly ["Update", "TakeDamage", "TryMeleeHit", "TryRangeHit", "TryHit", "CauseMeleeHit", "MissMeleeHit"];
/**任何角色通用的事件类型
 * u为角色 n不存在
 */
