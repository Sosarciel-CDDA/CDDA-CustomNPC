 ...
 * u为角色 n不存在
 */
export declare const CommonEventTypeList: readonly [];
/**任何角色通用的事件类型
 * u为角色 n不存在
 */
 ...
 * u为角色 n不存在
 */
export declare const CnpcEventTypeList: readonly ["CnpcIdle", "CnpcMove", "CnpcUpdate", "CnpcUpdateSlow", "CnpcInit", "CnpcBattleUpdate", "CnpcNonBattleUpdate", "CnpcDeath", "CnpcDeathPrev", "CnpcDeathAfter", "CnpcEnterBattle", "CnpcTryMeleeHit", "CnpcTryRangeHit", "CnpcTryHit", "CnpcCheckTakeDamage", "CnpcCheckTakeRangeDamage", "CnpcCheckTakeMeleeDamage", "CnpcCheckCauseMeleeHit", "CnpcCheckCauseRangeHit", "CnpcCheckCauseHit"];
/**Cnpc角色事件类型 */
...
/**任何Cnpc角色事件 列表 */
export declare const AnyCnpcEventTypeList: readonly ["CnpcIdle", "CnpcMove", "CnpcUpdate", "CnpcUpdateSlow", "CnpcInit", "CnpcBattleUpdate", "CnpcNonBattleUpdate", "CnpcDeath", "CnpcDeathPrev", "CnpcDeathAfter", "CnpcEnterBattle", "CnpcTryMeleeHit", "CnpcTryRangeHit", "CnpcTryHit", "CnpcCheckTakeDamage", "CnpcCheckTakeRangeDamage", "CnpcCheckTakeMeleeDamage", "CnpcCheckCauseMeleeHit", "CnpcCheckCauseRangeHit", "CnpcCheckCauseHit", "CnpcCheckCauseDamage", "CnpcCheckCauseMeleeDamage", "CnpcCheckCauseRangeDamage"];
/**任何Cnpc角色事件 */
