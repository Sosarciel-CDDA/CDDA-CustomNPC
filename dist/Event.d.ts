 ...
 * u为角色 n为怪物
 */
export declare const CnpcInteractiveEventList: readonly ["CnpcCheckCauseMeleeHit", "CnpcCheckCauseRangeHit", "CnpcCheckCauseHit"];
/**Cnpc角色与怪物互动的事件 */
 ...
 * u为角色 n不存在
 */
export declare const CnpcEventTypeList: readonly ["CnpcIdle", "CnpcMove", "CnpcUpdate", "CnpcUpdateSlow", "CnpcInit", "CnpcBattleUpdate", "CnpcNonBattleUpdate", "CnpcDeath", "CnpcDeathPrev", "CnpcDeathAfter", "CnpcEnterBattle", "Update", "TryMeleeHit", "TryRangeHit", "TryHit", "TakeDamage", "CauseMeleeHit", "MissMeleeHit", "CnpcCheckCauseMeleeHit", "CnpcCheckCauseRangeHit", "CnpcCheckCauseHit"];
/**Cnpc角色事件类型 */
 ...
 * n为角色 u为受害者
 */
export declare const CnpcReverseEventTypeList: readonly ["CnpcCheckTakeHit", "CnpcCheckTakeMeleeHit", "CnpcCheckTakeRangeHit"];
/**Cnpc角色的 反转Talker的角色事件类型
 * 对应同名CauseDamage
 */
export type CnpcReverseEventType = typeof CnpcReverseEventTypeList[number];
/**任何Cnpc角色事件 列表 */
export declare const AnyCnpcEventTypeList: readonly ["CnpcIdle", "CnpcMove", "CnpcUpdate", "CnpcUpdateSlow", "CnpcInit", "CnpcBattleUpdate", "CnpcNonBattleUpdate", "CnpcDeath", "CnpcDeathPrev", "CnpcDeathAfter", "CnpcEnterBattle", "Update", "TryMeleeHit", "TryRangeHit", "TryHit", "TakeDamage", "CauseMeleeHit", "MissMeleeHit", "CnpcCheckCauseMeleeHit", "CnpcCheckCauseRangeHit", "CnpcCheckCauseHit", "CnpcCheckTakeHit", "CnpcCheckTakeMeleeHit", "CnpcCheckTakeRangeHit"];
/**任何Cnpc角色事件 */
