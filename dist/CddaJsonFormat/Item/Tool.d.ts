...
import { CddaID, CopyfromVar, Power as Capacity, DescText } from "../GenericDefine";
...
/**工具可用的flag 列表 */
export declare const ToolFlagList: readonly [];
/**工具可用的flag */
export type ToolFlag = typeof ToolFlagList[number] | GenericFlag;
/**
