...
/**附魔近战武器加值类型 列表 */
export declare const EnchMeleeValTypeList: readonly ["ITEM_DAMAGE_ACID", "ITEM_DAMAGE_BASH", "ITEM_DAMAGE_BIO", "ITEM_DAMAGE_BULLET", "ITEM_DAMAGE_COLD", "ITEM_DAMAGE_CUT", "ITEM_DAMAGE_ELEC", "ITEM_DAMAGE_HEAT", "ITEM_DAMAGE_PURE", "ITEM_DAMAGE_STAB"];
/**附魔近战武器加值类型 */
export type EnchMeleeValType = typeof EnchMeleeValTypeList[number];
/**附魔护甲加值类型 列表 */
export declare const EnchArmorValTypeList: readonly ["ITEM_ARMOR_ACID", "ITEM_ARMOR_BASH", "ITEM_ARMOR_BIO", "ITEM_ARMOR_BULLET", "ITEM_ARMOR_COLD", "ITEM_ARMOR_CUT", "ITEM_ARMOR_ELEC", "ITEM_ARMOR_HEAT", "ITEM_ARMOR_STAB", "ITEM_ATTACK_SPEED"];
/**附魔护甲加值类型 */
